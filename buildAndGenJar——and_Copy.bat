...
copy "%~dp0\jar\custom_spider.jar" "D:\PythonProject\PythonProjects\projects\tvbox\custom_spider.jar"
copy "%~dp0\jar\custom_spider.jar" "D:\PythonProject\PythonProjects\projects\tvbox\custom\spider\custom_spider.jar"
copy "%~dp0\jar\custom_spider.jar" "D:\PythonProject\PythonProjects\projects\tvbox\custom_spider_debug.jar"
